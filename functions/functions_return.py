# 3/25/2021 Function with return ststament
# function is block of code that can be reusable
#
...
# student.txt = print_formatted_name('baur', 'eskara')
# print(f"value of student.txt is : {student.txt}")
# print(f"value of student.txt is : {print_formatted_name('baur', 'eskara')}")
...
def get_list_of_even_numbers(num: int) -> list:# experienced coders do
    """
